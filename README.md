...
**Extração:** a base foi lida com `pandas.read_csv`, usando `;` como separador e aproveitando apenas as 10 colunas significativas. A inspeção inicial apontou 830.000 registros.
